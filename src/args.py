...
def build_parser():
	...
	# FL parameters
	parser.add_argument('-lang', type=str, default='Dyck', choices= ['Dyck', 'Counter', 'Shuffle','Parity','CRL', 'AAStarBBStar','ABStar','ABABStar', 'AAStar','Tomita','Boolean','CStarAnCStar','CStarAnCStarBnCStar','CStarAnCStarv2','RDyck','CAB_n_ABD','AnStarA2','D_n','Concatv1','Concatv2'], help='Formal Language')
	...
	parser.add_argument('-test_prefix', type=str, default='test', help='Test data prefix')
	...
	parser.add_argument('-tune_threshold', dest='tune_threshold', action='store_true', help='Tune Threshold')
